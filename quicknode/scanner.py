...
if __name__ == "__main__":
    ...
    # TOKEN_ADDRESS = "0x9390D05C0643ABC62a6680f118570a3ACAB37B26"
    ...
    def run():
        ...
        if len(sys.argv) < 2:
            print("Usage: eventscanner.py https://opt-mainnet.g.alchemy.com/v2/bjsw4mIncmXszy3-UoYdPnvlQb6b6Wep 0xTokenAddress")
            sys.exit(1)
